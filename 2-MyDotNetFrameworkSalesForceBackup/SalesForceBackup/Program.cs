...
//        _appSettings = TinyIoCContainer.Current.Resolve<IAppSettings>();
//        _appSettings.age = 10;
//        var _appSettings1 = TinyIoCContainer.Current.Resolve<IAppSettings>();
//        Console.WriteLine(_appSettings1.age);
//        AssignValuesFromArguments(args);
...
//        backup.age = 1;
//        var backup2 = TinyIoCContainer.Current.Resolve<Backup>();
//        Console.WriteLine(backup2.age);
//        //consoleErrorHandler2.age = 1;
//        backup.Run();
